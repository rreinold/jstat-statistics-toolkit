...
* `JStatExGenerateData` - Generates 100 datapoints, stores in `vibration_sensor_1` Collection 
* `JStatExNormalDeviate` - Create a normal deviate dataset
* `JStatExNormalDistributionAdvanced` - Pull dataset from collection, build model
* `JStatExNormalDistributionStatic` - Use static dataset, build model	
#### Test
